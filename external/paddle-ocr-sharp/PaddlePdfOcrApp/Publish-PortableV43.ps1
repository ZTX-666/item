...
# V43：預設框架依賴（體積小）；目標機需 .NET 8 Desktop Runtime，或先執行 install-environment.ps1。
# SelfContained = 自包含（體積大），可不裝 .NET，程式內「一鍵配置環境」主要配置 Python。
...
$out = Join-Path $here 'publish\portable_v43'
...
Write-Host 'Publish v43 finished.' -ForegroundColor Green
