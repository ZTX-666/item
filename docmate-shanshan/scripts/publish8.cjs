...
const dest = path.join(root, 'publish8')
const PUBLISH_NAME = 'publish8'

const INCLUDE_DIRS = ['src', 'electron', 'public']
const INCLUDE_SCRIPTS = ['release.cjs', 'publish8.cjs', 'test-llm.cjs']
const INCLUDE_FILES = [
  'package.json',
  'package-lock.json',
  'index.html',
...
1. 拖动选中文字，蓝色高亮保持（点击面板不会取消）
2. 选区上方 Bubble 操作条：语音或输入修改要求
