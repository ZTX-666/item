    ...
    <div v-else-if="hasWork" class="worklist">
      ...
      <div class="worklist__items">
        ...
        >
          ...
          />
          <span class="diff-item__body">
            <span class="diff-item__head">
            ...
            <span class="diff-line diff-line--old">{{ item.card.before }}</span>
            <span class="diff-line diff-line--new">{{ item.card.after }}</span>
          </span>
        </label>
      </div>
...
<style scoped>
.diff-review {
  --review-text: var(--text-primary, #1a1d23);
  --review-muted: var(--text-secondary, #5b626c);
  --review-panel: var(--bg-subtle, #f5f7fa);
  --review-hover: var(--bg-hover, #eef1f5);
  --review-border: var(--border-light, #e8eaef);
...
.diff-item--selected {
  background: rgb(15 158 213 / 8%);
  border-color: rgb(15 158 213 / 38%);
}
